...
const CALC_LIST = {
  finance: {
    investment: [
      ...
      { slug: 'dividend-calculator',  name: 'Dividend Calculator' },
    ...
    banking: [
      ...
      { slug: 'interest-rate',        name: 'Interest Rate Calculator' },
    ],
    income: [
  ...
  math: {
    ...
    algebra: [
      { slug: 'quadratic-solver',     name: 'Quadratic Solver' },
      { slug: 'linear-equation',      name: 'Linear Equation Solver' },
      { slug: 'systems-equations',    name: 'Systems of Equations' },
      { slug: 'polynomial-roots',     name: 'Polynomial Roots' },
    ...
    statistics: [
      ...
      { slug: 'standard-deviation',   name: 'Standard Deviation' },
      { slug: 'probability-calculator',name:'Probability Calculator' },
      { slug: 'normal-distribution',  name: 'Normal Distribution' },
      ...
      <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
        ...
        <div style={{ background: 'var(--bg-card)', borderBottom: '1px solid var(--border)', padding: '36px 0 28px' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 40px' }}>
            <h1 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 32, fontWeight: 800,
            ...
            <div style={{ position: 'relative', maxWidth: 480, marginTop: 22 }}>
              ...
              <input type="text" value={search} onChange={e => setSearch(e.target.value)}
                ...
                style={{ width: '100%', padding: '11px 38px', border: '1.5px solid var(--border-2)',
            ...
            {/* Quick jump pills — uses category.color and colorLight directly */}
            {!q && (
