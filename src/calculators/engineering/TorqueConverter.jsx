...
const UNITS = [
  { key: 'nm',    label: 'Newton-metres',  symbol: 'N·m',   factor: 1       },
  { key: 'knm',   label: 'Kilonewton-m',  symbol: 'kN·m',  factor: 1000    },
  { key: 'ftlb',  label: 'Foot-pounds',   symbol: 'ft·lb', factor: 1.35582 },
  { key: 'inlb',  label: 'Inch-pounds',   symbol: 'in·lb', factor: 0.112985},
  { key: 'inoz',  label: 'Inch-ounces',   symbol: 'in·oz', factor: 0.00706155},
  { key: 'kgfm',  label: 'kgf-metres',    symbol: 'kgf·m', factor: 9.80665 },
  { key: 'kgfcm', label: 'kgf-cm',        symbol: 'kgf·cm',factor: 0.0980665},
  { key: 'dyncm', label: 'Dyne-cm',       symbol: 'dyn·cm',factor: 1e-7    },
]

const FAQ = [
  { q: 'What is torque vs moment?', a: 'Torque and moment both describe rotational effect = force × distance. Torque typically refers to a twisting force that causes rotation (engine, fastener). Moment refers to bending or rotation tendency in structural analysis. Numerically identical; context determines the term used.' },
  { q: 'How do I convert N·m to ft·lb for engine specs?', a: '1 N·m = 0.737562 ft·lb. Divide N·m by 1.3558 to get ft·lb. A car engine rated at 300 N·m = 300 × 0.7376 = 221 ft·lb. European specs use N·m; US specs typically use ft·lb.' },
]
...
export default function TorqueConverter({ meta, category }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div style={{ background: `linear-gradient(135deg,${C}15,${C}06)`, border: `1px solid ${C}30`, borderRadius: 14, padding: '16px 20px' }}>
        <div style={{ fontSize: 10, fontWeight: 700, color: C, textTransform: 'uppercase', letterSpacing: '.08em', marginBottom: 8 }}>Torque Converter</div>
