export const categories = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'vitals', name: 'Vital Health', icon: '❤️', count: 8,
        ...
        mostUsed: ['bmi-calculator', 'blood-pressure', 'resting-heart-rate', 'sleep-calculator', 'age-calculator', 'blood-type', 'oxygen-saturation', 'temperature-converter'] },
  ...
  },
  {
    ...
    count: '33',
    description: 'Percentage, algebra, statistics, fractions, date & time, probability, linear algebra and calculus. Clean, fast math calculators with step-by-step explanations.',
    subcategories: [
      { slug: 'basic', name: 'Basic Math', icon: '🔢', count: 5,
        description: 'Fast calculators for everyday math — percentages, fractions, ratios, averages and rounding. All show the working step-by-step.',
        mostUsed: ['percentage-calculator', 'fraction-calculator', 'average-calculator', 'ratio-calculator', 'rounding-calculator'] },
      { slug: 'algebra', name: 'Algebra', icon: '📉', count: 9,
        description: 'Solve algebra problems with full step-by-step working. From linear equations to quadratic solvers, systems of equations, matrices and graphing.',
        mostUsed: ['quadratic-solver', 'linear-equation', 'systems-equations', 'polynomial-roots', 'exponent-calculator', 'logarithm-calculator', 'matrix-calculator', 'determinant-calculator', 'graphing-calculator'] },
      { slug: 'linear-algebra', name: 'Linear Algebra', icon: '🔢', count: 2,
        description: 'Linear algebra calculators for matrix inverses and eigenvalues.',
        mostUsed: ['matrix-inverse', 'eigenvalues-calculator'] },
      { slug: 'calculus', name: 'Calculus', icon: '∫', count: 2,
        description: 'Derivative and integral calculators with step-by-step working.',
        mostUsed: ['derivative-calculator', 'integral-calculator'] },
      { slug: 'statistics', name: 'Statistics', icon: '📊', count: 6,
        description: 'Statistical calculators for data analysis and probability distributions. Calculate mean, median, mode, standard deviation, normal distribution and correlation.',
        mostUsed: ['mean-median-mode', 'standard-deviation', 'probability-calculator', 'normal-distribution', 'correlation', 'confidence-interval'] },
      { slug: 'date-time', name: 'Date & Time', icon: '📅', count: 5,
        description: 'Date and time calculators for age, duration, deadlines and working days. Find the difference between two dates and calculate business days.',
        mostUsed: ['age-calculator', 'date-difference', 'add-subtract-days', 'working-days', 'time-zone-converter'] },
      { slug: 'probability', name: 'Probability', icon: '🎲', count: 4,
        description: 'Probability and combinatorics calculators for permutations, combinations, dice rolls and card game odds.',
        mostUsed: ['probability-calculator', 'permutations', 'combinations', 'dice-probability'] },
    ],
  },
  {
