export const categories = [
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'vitals', name: 'Vital Health', icon: '❤️', count: 6,
        ...
        mostUsed: [ 'blood-pressure', 'resting-heart-rate', 'age-calculator', 'blood-type', 'oxygen-saturation', 'temperature-converter'] },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { slug: 'date-time', name: 'Date & Time', icon: '📅', count: 4,
        ...
        mostUsed: [ 'date-difference', 'add-subtract-days', 'working-days', 'time-zone-converter'] },
