export const calculators = [
  ...
  // Body Metrics
  {
    ...
    related: ['body-fat-calculator', 'ideal-weight-calculator', 'bmr-calculator'],
  },
  {
    slug: 'body-fat-calculator', name: 'Body Fat Percentage Calculator',
    category: 'health', subcategory: 'body-metrics', inputStyle: 'fields',
    ...
    related: ['bmi-calculator', 'ideal-weight-calculator', 'lean-body-mass-calculator'],
  },
  {
  ...
  },
  {
    ...
    related: ['body-fat-calculator', 'bmr-calculator', 'macro-calculator'],
  },
  {
    slug: 'waist-hip-ratio-calculator', name: 'Waist-to-Hip Ratio Calculator',
    category: 'health', subcategory: 'body-metrics', inputStyle: 'fields',
  ...
  {
    slug: 'body-surface-area-calculator', name: 'Body Surface Area Calculator',
    category: 'health', subcategory: 'body-metrics', inputStyle: 'fields',
  ...
  },
  {
    ...
    related: ['ideal-weight-calculator', 'bmi-calculator', 'lean-body-mass-calculator'],
  },
  // Calories & Nutrition
  {
  ...
  },
  {
    ...
    related: ['macro-calculator', 'lean-body-mass-calculator', 'calorie-calculator'],
  },
  {
...

  {
    ...
    category: 'engineering', subcategory: 'materials', inputStyle: 'fields',
    description: 'Calculate the change in length of a material due to temperature changes.',
    about: 'Linear thermal expansion occurs when an object expands or contracts due to a change in temperature. It is calculated using ΔL = α * L₀ * ΔT, where α is the coefficient of linear expansion. This tool helps predict dimensional changes in piping, bridges, and mechanical parts.',
    related: ['stress-strain', 'heat-transfer-calculator', 'pipe-sizing'],
  },
  {
    slug: 'youngs-modulus', name: "Young's Modulus Calculator",
    category: 'engineering', subcategory: 'materials', inputStyle: 'fields',
    description: 'Calculate the stiffness of a solid material (Elastic Modulus).',
    about: 'Young\'s Modulus (E) measures the ability of a material to withstand changes in length under lengthwise tension or compression. Defined as E = Stress / Strain, it is a fundamental property used in structural engineering and beam deflection calculations.',
    related: ['stress-strain', 'beam-deflection', 'beam-load-calculator'],
  },
  {
    slug: 'material-density', name: 'Material Density Calculator',
    category: 'engineering', subcategory: 'materials', inputStyle: 'fields',
    description: 'Calculate density, mass, or volume for various engineering materials.',
    about: 'Density (ρ) is the mass per unit volume of a substance (ρ = m / V). This calculator is essential for weight estimation in aerospace, civil, and mechanical design, allowing for quick conversions between kg/m³, lb/ft³, and g/cm³.',
    related: ['steel-weight-calculator', 'concrete-volume-calculator', 'weight-converter'],
  },
  {
    slug: 'hardness-converter', name: 'Hardness Scale Converter',
    category: 'engineering', subcategory: 'materials', inputStyle: 'fields',
    description: 'Convert between Rockwell (HRC/HRB), Brinell (HB), and Vickers (HV) hardness scales.',
    about: 'Material hardness is the measure of resistance to localized plastic deformation. Because different industries use different testing methods, this converter allows for empirical mapping between Rockwell C, Rockwell B, Brinell, and Vickers scales.',
  ...
  // Arithmetic
  {
    ...
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
  ...
  },
  {
    ...
    about: 'Percentage change measures how much a quantity has increased or decreased relative to its original value. Formula: ((New - Old) / Old) × 100%. This calculator handles both positive and negative changes and shows step-by-step working for transparency.',
    related: ['percentage-calculator', 'ratio-calculator', 'percent-error'],
  },
  {
    ...
    about: 'Percent error measures how far an experimental or measured value is from the theoretical or true value. Used in science, engineering and quality control. Formula: (|Experimental - Theoretical| / Theoretical) × 100%. Shows absolute and relative error.',
    related: ['percentage-calculator', 'percentage-change', 'average-calculator'],
  },
  {
    slug: 'decimal-fraction-converter', name: 'Decimal & Fraction Converter',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Convert between decimal and fraction representations of numbers.',
    about: 'Convert any decimal to a fraction in simplified form, or convert any fraction to its decimal equivalent. Handles terminating and repeating decimals. Shows working steps and useful for understanding equivalent representations.',
    related: ['fraction-calculator', 'percentage-calculator', 'ratio-calculator'],
  },
  {
    slug: 'square-root-calculator', name: 'Square Root Calculator',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Calculate square roots and nth roots with decimal precision.',
    about: 'Compute the square root, cube root or any nth root of a number. Shows both exact and approximate decimal forms. Includes calculation of perfect squares/cubes/powers reference guide.',
    related: ['exponent-calculator', 'average-calculator', 'percentage-calculator'],
  },
  {
    slug: 'gcf-calculator', name: 'GCF & LCM Calculator',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Find greatest common factor (GCF) and least common multiple (LCM).',
    about: 'GCF and LCM are essential for simplifying fractions and solving problems involving multiples. Shows prime factorization, common factors/multiples, and step-by-step working for educational clarity.',
    related: ['fraction-calculator', 'prime-factorization', 'ratio-calculator'],
  },
  {
    slug: 'prime-factorization', name: 'Prime Factorization',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Express any number as a product of prime factors.',
    about: 'Prime factorization breaks down a number into its prime number components. Shows the complete factorization using exponent notation and a factor tree. Essential for understanding number properties and simplifying expressions.',
    related: ['gcf-calculator', 'prime-checker', 'ratio-calculator'],
  },
  {
    slug: 'factorial-calculator', name: 'Factorial Calculator',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Calculate factorial n! = 1 × 2 × 3 × ... × n.',
    about: 'Factorial of n is the product of all positive integers up to n. Used in combinations, permutations, probability and many mathematical formulas. Supports large numbers and shows step-by-step computation.',
    related: ['combinations', 'permutations', 'probability-calculator'],
  },
  {
    slug: 'scientific-notation', name: 'Scientific Notation Calculator',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Convert numbers to and from scientific notation.',
    about: 'Express any number in scientific notation (a × 10^n). Useful for very large or very small numbers in science and engineering. Shows conversions both ways with explanation of mantissa and exponent.',
    related: ['exponent-calculator', 'average-calculator', 'percentage-calculator'],
  },
  {
    slug: 'number-base-converter', name: 'Number Base Converter',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Convert between decimal, binary, octal, and hexadecimal bases.',
    about: 'Different number bases (radix systems) are used in computing and mathematics. Convert between base 10 (decimal), base 2 (binary used in computers), base 8 (octal), and base 16 (hexadecimal). Shows step-by-step conversion process.',
    related: ['percentage-calculator', 'ratio-calculator', 'average-calculator'],
  },
  {
    slug: 'random-number', name: 'Random Number Generator',
    category: 'math', subcategory: 'arithmetic', inputStyle: 'fields',
    description: 'Generate random numbers with custom min, max, count and seed control.',
    about: 'Generate truly random or pseudo-random numbers from any range. Useful for simulations, games, sampling and statistical experiments. Control count, range, decimal places and optional seed for reproducibility.',
    related: ['average-calculator', 'percentage-calculator', 'probability-calculator'],
  },
  // Geometry
  {
    slug: 'area-calculator', name: 'Area Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Calculate area of circles, triangles, rectangles, trapezoids and more.',
    about: 'Compute the area of any common 2D shape: circles, triangles, rectangles, squares, trapezoids, parallelograms, ellipses and sectors. Shows formula used and step-by-step calculation for transparency.',
    related: ['perimeter-calculator', 'volume-calculator', 'pythagorean-theorem'],
  },
  {
    slug: 'perimeter-calculator', name: 'Perimeter Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Calculate perimeter of any 2D shape.',
    about: 'Find the perimeter (total distance around) any polygon or shape. Handles circles (circumference), triangles, rectangles, regular polygons and more. Shows formula and step-by-step working.',
    related: ['area-calculator', 'circle-calculator', 'triangle-calculator'],
  },
  {
    slug: 'volume-calculator', name: 'Volume Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Calculate volume of cubes, spheres, cylinders, cones and more.',
    about: 'Compute volume of common 3D shapes: cubes, rectangular prisms, spheres, cylinders, cones, pyramids, ellipsoids and toroids. Shows formula and step-by-step calculation. Useful for engineering, construction and science.',
    related: ['surface-area-calculator', 'area-calculator', 'pythagorean-theorem'],
  },
  {
    slug: 'surface-area-calculator', name: 'Surface Area Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Calculate surface area of 3D shapes.',
    about: 'Find the total surface area of common 3D objects: spheres, cylinders, cones, cubes, rectangular prisms, pyramids and more. Shows formula and step-by-step computation. Useful for material estimating and understanding 3D geometry.',
    related: ['volume-calculator', 'area-calculator', 'circle-calculator'],
  },
  {
    slug: 'pythagorean-theorem', name: 'Pythagorean Theorem Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Find missing side of right triangle using a² + b² = c².',
    about: 'The Pythagorean theorem relates the three sides of a right triangle. Given any two sides, find the third. Shows the formula a² + b² = c² and step-by-step working. Essential for right triangle problems in geometry.',
    related: ['right-triangle', 'triangle-calculator', 'slope-calculator'],
  },
  {
    slug: 'triangle-calculator', name: 'Triangle Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Find sides, angles, area and perimeter of any triangle.',
    about: 'Complete triangle analysis: given any combination of sides and angles, find all missing information. Computes area using multiple methods (Heron\'s formula, base×height), perimeter, angles, and height. Shows step-by-step working.',
    related: ['pythagorean-theorem', 'right-triangle', 'area-calculator'],
  },
  {
    slug: 'right-triangle', name: 'Right Triangle Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Calculate angles and sides of right triangles.',
    about: 'Specialized calculator for right triangles using trigonometry and Pythagorean theorem. Given any two pieces of information, finds all sides, all angles, area and perimeter. Useful for surveying, construction and navigation.',
    related: ['pythagorean-theorem', 'triangle-calculator', 'trig-calculator'],
  },
  {
    slug: 'circle-calculator', name: 'Circle Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Calculate radius, diameter, circumference and area of circles.',
    about: 'Complete circle calculations: given radius, diameter, circumference or area of a circle, find all other measurements. Shows all formulas used. Useful in geometry, engineering and physics.',
    related: ['area-calculator', 'perimeter-calculator', 'volume-calculator'],
  },
  {
    slug: 'slope-calculator', name: 'Slope & Distance Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Calculate slope, angle and distance between two points.',
    about: 'Find the slope (rate of change), angle of inclination, and distance between two coordinate points. Shows all formulas, step-by-step working, and a visualization. Essential for coordinate geometry and linear equations.',
    related: ['angle-calculator', 'pythagorean-theorem', 'linear-equation'],
  },
  {
    slug: 'angle-calculator', name: 'Angle Calculator',
    category: 'math', subcategory: 'geometry', inputStyle: 'fields',
    description: 'Convert between degrees, radians and other angle units.',
    about: 'Working with angles in different measurement units (degrees, radians, grads) requires quick conversions. Also calculates angles between lines and from slope. Shows all conversion formulas.',
    related: ['angle-converter', 'triangle-calculator', 'trig-calculator'],
  },
  // Algebra
  {
  ...
  },
  {
    ...
    category: 'math', subcategory: 'calculus', inputStyle: 'fields',
    description: 'Calculate limits of functions as x approaches any value.',
    about: 'Find the limit of any function as x approaches a specific value (including infinity). Shows left-hand and right-hand limits, identifies discontinuities, and helps with understanding continuity and derivatives.',
    related: ['derivative-calculator', 'integral-calculator', 'graphing-calculator'],
  },
  {
    ...
    about: 'Compute partial derivatives of functions with two or more variables. Shows the process of treating some variables as constants while differentiating with respect to others. Essential for multivariable calculus and optimization.',
    related: ['derivative-calculator', 'integral-calculator', 'double-integral'],
  },
  {
    slug: 'double-integral', name: 'Double Integral Calculator',
    category: 'math', subcategory: 'calculus', inputStyle: 'fields',
    description: 'Calculate double integrals over rectangular and polar regions.',
    about: 'Compute double integrals of functions of two variables. Supports both Cartesian (rectangular) and polar coordinate systems. Shows step-by-step integration and applications to area and volume problems.',
    related: ['partial-derivative', 'integral-calculator', 'volume-calculator'],
  },
  {
    slug: 'taylor-series', name: 'Taylor & Maclaurin Series',
    category: 'math', subcategory: 'calculus', inputStyle: 'fields',
    description: 'Find Taylor and Maclaurin series expansions of functions.',
    about: 'Express any smooth function as an infinite power series around a point. Maclaurin series is the special case around x=0. Shows the coefficients, partial sums, and visualization of how the series approximates the function.',
    related: ['derivative-calculator', 'polynomial-roots', 'exponential-growth'],
  },
  {
    slug: 'riemann-sum', name: 'Riemann Sum Calculator',
    category: 'math', subcategory: 'calculus', inputStyle: 'fields',
    description: 'Approximate integrals using left, right, midpoint and trapezoid rules.',
    about: 'Riemann sums are numerical methods to approximate definite integrals. Compare left endpoint, right endpoint, midpoint, and trapezoid rule methods with increasing subdivisions. Fundamental to understanding how integration works.',
    related: ['integral-calculator', 'trapezoidal-rule', 'derivative-calculator'],
  },
  // Trigonometry
  {
    slug: 'trig-calculator', name: 'Sin, Cos & Tan Calculator',
    category: 'math', subcategory: 'trigonometry', inputStyle: 'fields',
    description: 'Calculate sine, cosine, tangent and other trig functions.',
    about: 'Trigonometric functions relate angles to side ratios in right triangles. Compute sin, cos, tan, cot, sec and csc for any angle in degrees or radians. Shows exact values and decimal approximations.',
    related: ['inverse-trig', 'angle-converter', 'right-triangle'],
  },
  {
    ...
    about: 'Inverse trigonometric functions find the angle given a trigonometric ratio. Compute arcsin (sin^-1), arccos (cos^-1), arctan (tan^-1) and their reciprocals. Output in degrees or radians.',
    related: ['trig-calculator', 'angle-converter', 'right-triangle'],
  },
  {
    slug: 'angle-converter', name: 'Degrees & Radians Converter',
    category: 'math', subcategory: 'trigonometry', inputStyle: 'fields',
    description: 'Convert between degrees, radians and other angle units.',
    about: 'Convert angles between degrees (360° = full circle), radians (2π = full circle), gradians and revolutions. Shows exact conversions and helps with understanding different angle measurement systems.',
    related: ['trig-calculator', 'inverse-trig', 'unit-circle'],
  },
  {
    slug: 'law-of-sines', name: 'Law of Sines Calculator',
    category: 'math', subcategory: 'trigonometry', inputStyle: 'fields',
    description: 'Solve triangles using the Law of Sines: a/sin(A) = b/sin(B) = c/sin(C).',
    about: 'Law of Sines relates side lengths to their opposite angles in any triangle. Given sides and angles, find missing information. Essential for solving non-right triangles.',
    related: ['law-of-cosines', 'triangle-calculator', 'trig-calculator'],
  },
  {
    slug: 'law-of-cosines', name: 'Law of Cosines Calculator',
    category: 'math', subcategory: 'trigonometry', inputStyle: 'fields',
    description: 'Solve triangles using Law of Cosines: c² = a² + b² - 2ab·cos(C).',
    about: 'Generalization of Pythagorean theorem for any triangle. Given sides or angles, find missing information using the law: c² = a² + b² - 2ab·cos(C). Essential for non-right triangles.',
    related: ['law-of-sines', 'pythagorean-theorem', 'triangle-calculator'],
  },
  {
    slug: 'unit-circle', name: 'Unit Circle Reference',
    category: 'math', subcategory: 'trigonometry', inputStyle: 'fields',
    description: 'Interactive unit circle showing angles, coordinates and trig values.',
    about: 'The unit circle (radius 1) is fundamental to trigonometry. Shows relationship between angles and coordinates (cos θ, sin θ). Interactive display of all six trig functions as angle varies.',
    related: ['trig-calculator', 'inverse-trig', 'angle-converter'],
  },
  {
    slug: 'trig-identities', name: 'Trig Identity Verifier',
    category: 'math', subcategory: 'trigonometry', inputStyle: 'fields',
    description: 'Verify and simplify trigonometric identities.',
    about: 'Check whether trigonometric identities are correct. Reference guide for all major trig identities (Pythagorean, sum/difference, double angle, half angle, product-to-sum). Helps with trigonometric simplification.',
    related: ['trig-calculator', 'derivative-calculator', 'integral-calculator'],
  },
  // Differential Equations
  {
    slug: 'ode-first-order', name: '1st Order ODE Solver',
    category: 'math', subcategory: 'differential-equations', inputStyle: 'fields',
    description: 'Solve first-order differential equations analytically and numerically.',
    about: 'First-order ODEs have the form dy/dx = f(x,y). Solves separable equations, linear equations, and Bernoulli equations. Includes both exact and numerical solutions with visualization.',
    related: ['ode-second-order', 'derivative-calculator', 'integral-calculator'],
  },
  {
    slug: 'ode-second-order', name: '2nd Order ODE Solver',
    category: 'math', subcategory: 'differential-equations', inputStyle: 'fields',
    description: 'Solve second-order linear differential equations.',
    about: 'Second-order linear ODEs: d²y/dx² + p(x)dy/dx + q(x)y = f(x). Solves homogeneous and non-homogeneous equations with constant coefficients. Useful in physics and engineering.',
    related: ['ode-first-order', 'laplace-transform', 'integral-calculator'],
  },
  {
    slug: 'laplace-transform', name: 'Laplace Transform Calculator',
    category: 'math', subcategory: 'differential-equations', inputStyle: 'fields',
    description: 'Calculate Laplace transforms of common functions.',
    about: 'Laplace transform converts differential equations into algebraic equations. Computes L{f(t)} = F(s) for standard functions. Essential tool for solving ODEs and analyzing control systems.',
    related: ['inverse-laplace', 'ode-first-order', 'ode-second-order'],
  },
  {
    slug: 'inverse-laplace', name: 'Inverse Laplace Transform',
    category: 'math', subcategory: 'differential-equations', inputStyle: 'fields',
    description: 'Find inverse Laplace transforms using standard tables and partial fractions.',
    about: 'Inverse Laplace transform converts back from frequency domain to time domain. Solves L⁻¹{F(s)} = f(t) using partial fraction decomposition and standard tables. Used in engineering control systems.',
    related: ['laplace-transform', 'ode-second-order', 'derivative-calculator'],
  },
  // Linear Algebra (continued - adding missing entries)
  {
    slug: 'rank-of-matrix', name: 'Rank of a Matrix',
    category: 'math', subcategory: 'linear-algebra', inputStyle: 'fields',
    description: 'Calculate the rank of any matrix.',
    about: 'Matrix rank is the dimension of the vector space spanned by rows or columns. Computed using Gaussian elimination (row reduction). Important for understanding matrix properties and solution existence of linear systems.',
    related: ['matrix-inverse', 'determinant-calculator', 'gauss-elimination'],
  },
  {
    slug: 'gauss-elimination', name: 'Gauss Elimination Solver',
    category: 'math', subcategory: 'linear-algebra', inputStyle: 'fields',
    description: 'Solve systems of equations using Gaussian elimination (row reduction).',
    about: 'Gaussian elimination with back-substitution solves linear systems. Shows each row operation step-by-step. Works for any size system and identifies inconsistent or dependent systems.',
    related: ['systems-equations', 'matrix-inverse', 'rank-of-matrix'],
  },
  {
    slug: 'dot-product', name: 'Dot Product Calculator',
    category: 'math', subcategory: 'linear-algebra', inputStyle: 'fields',
    description: 'Calculate dot (scalar) product of two vectors.',
    about: 'Dot product combines two vectors to produce a scalar. Formula: a·b = |a||b|cos(θ). Shows how to calculate, geometric interpretation, and applications to angles and orthogonality.',
    related: ['cross-product', 'vector-magnitude', 'matrix-calculator'],
  },
  {
    slug: 'cross-product', name: 'Cross Product Calculator',
    category: 'math', subcategory: 'linear-algebra', inputStyle: 'fields',
    description: 'Calculate cross (vector) product of two 3D vectors.',
    about: 'Cross product of two 3D vectors produces a vector perpendicular to both. Shows formula using determinants, geometric interpretation, and right-hand rule. Essential for 3D geometry and physics.',
    related: ['dot-product', 'vector-magnitude', 'determinant-calculator'],
  },
  {
    slug: 'vector-magnitude', name: 'Vector Magnitude & Unit Vector',
    category: 'math', subcategory: 'linear-algebra', inputStyle: 'fields',
    description: 'Calculate vector magnitude (length) and find unit vectors.',
    about: 'Vector magnitude (norm) measures vector length using Euclidean distance formula. Find unit vectors (magnitude = 1) in any direction. Includes visualization and applications.',
    related: ['dot-product', 'cross-product', 'slope-calculator'],
  },
  // Statistics (continued - adding missing entries)
  {
    slug: 'variance-calculator', name: 'Variance Calculator',
    category: 'math', subcategory: 'statistics', inputStyle: 'fields',
    description: 'Calculate population and sample variance.',
    about: 'Variance measures spread of data around the mean. Calculates both population variance (σ²) and sample variance (s²). Shows step-by-step working from deviation calculations.',
    related: ['standard-deviation', 'mean-median-mode', 'average-calculator'],
  },
  {
    slug: 'weighted-average', name: 'Weighted Average Calculator',
    category: 'math', subcategory: 'statistics', inputStyle: 'fields',
    description: 'Calculate weighted average when different values have different importance.',
    about: 'Weighted average accounts for different importance levels of each value. Formula: Σ(value × weight) / Σ(weight). Used in GPA, stock portfolio returns, and many practical applications.',
    related: ['average-calculator', 'mean-median-mode', 'standard-deviation'],
  },
  {
    slug: 'z-score-calculator', name: 'Z-Score Calculator',
    category: 'math', subcategory: 'statistics', inputStyle: 'fields',
    description: 'Calculate Z-scores to standardize data and find percentiles.',
    about: 'Z-score measures how many standard deviations a value is from the mean. Formula: (x - μ) / σ. Standardized to find percentiles, identify outliers, and compare values from different distributions.',
    related: ['normal-distribution', 'standard-deviation', 'mean-median-mode'],
  },
  {
    slug: 'regression-calculator', name: 'Linear Regression Calculator',
    category: 'math', subcategory: 'statistics', inputStyle: 'fields',
    description: 'Calculate linear regression line (best-fit line) and predictions.',
    about: 'Linear regression fits a line y = mx + b to data points using least squares method. Shows equation, R² value (goodness of fit), residuals, and can make predictions. Visualized with scatter plot.',
    related: ['correlation', 'standard-deviation', 'scatter-plot'],
  },
  {
    ...
    about: 'Determine how many samples needed for desired confidence level and margin of error. Works for population means and proportions. Essential for research design and statistical validity.',
    related: ['confidence-interval', 'normal-distribution', 'sample-variance'],
  },
  {
    slug: 'hypothesis-test', name: 'Hypothesis Test Calculator',
    category: 'math', subcategory: 'statistics', inputStyle: 'fields',
    description: 'Perform hypothesis tests for means and proportions.',
    about: 'Test statistical hypotheses using t-tests, z-tests and chi-square tests. Shows p-values, test statistics, and conclusions. Essential for determining statistical significance.',
    related: ['z-score-calculator', 'normal-distribution', 'confidence-interval'],
  },
  {
    slug: 'chi-square', name: 'Chi-Square Test Calculator',
    category: 'math', subcategory: 'statistics', inputStyle: 'fields',
    description: 'Perform chi-square test for independence and goodness of fit.',
    about: 'Chi-square test for independence examines relationship between categorical variables. Goodness of fit test checks if data matches an expected distribution. Shows test statistic and p-value.',
    related: ['hypothesis-test', 'normal-distribution', 'correlation'],
  },
  // Probability (continued - adding missing entries)
  {
    slug: 'bayes-theorem', name: "Bayes' Theorem Calculator",
    category: 'math', subcategory: 'probability', inputStyle: 'fields',
    description: 'Calculate conditional probability using Bayes\' theorem.',
    about: 'Bayes\' theorem calculates P(A|B) = P(B|A)P(A) / P(B). Essential for medical testing, spam filtering, and any problem about probability given evidence. Shows intuitive Venn diagram representation.',
    related: ['probability-calculator', 'conditional-probability', 'normal-distribution'],
  },
  {
    slug: 'binomial-distribution', name: 'Binomial Distribution Calculator',
    category: 'math', subcategory: 'probability', inputStyle: 'fields',
    description: 'Calculate binomial distribution probabilities for repeated trials.',
    about: 'Binomial distribution models experiments with fixed number of independent trials, each with same success probability. Calculates P(X=k), cumulative probabilities, mean and variance. Visualized with bar chart.',
    related: ['probability-calculator', 'combinations', 'normal-distribution'],
  },
  {
    slug: 'poisson-distribution', name: 'Poisson Distribution Calculator',
    category: 'math', subcategory: 'probability', inputStyle: 'fields',
    description: 'Calculate Poisson distribution probabilities for rare events.',
    about: 'Poisson distribution models count of events in a fixed interval. Used for rare events (radioactive decay, animal encounters). Shows probability mass function, mean, variance and cumulative probabilities.',
    related: ['binomial-distribution', 'probability-calculator', 'exponential-distribution'],
  },
  // Number Theory
  {
    slug: 'prime-checker', name: 'Prime Number Checker',
    category: 'math', subcategory: 'number-theory', inputStyle: 'fields',
    description: 'Check if a number is prime and find nearby primes.',
    about: 'Determine whether any number is prime (divisible only by 1 and itself). Shows prime factorization if composite. Finds next prime and previous prime. Explains primality tests.',
    related: ['prime-factorization', 'factor-calculator', 'gcf-calculator'],
  },
  {
    slug: 'factor-calculator', name: 'Factor Calculator',
    category: 'math', subcategory: 'number-theory', inputStyle: 'fields',
    description: 'Find all factors (divisors) of any number.',
    about: 'Lists all positive integers that divide evenly into a number. Shows both factors and factor pairs. Useful for understanding divisibility, finding GCD/LCM and primality.',
    related: ['prime-checker', 'prime-factorization', 'gcf-calculator'],
  },
  {
    slug: 'remainder-calculator', name: 'Remainder & Modulo Calculator',
    category: 'math', subcategory: 'number-theory', inputStyle: 'fields',
    description: 'Calculate remainder and modulo for division operations.',
    about: 'Compute remainder when dividing one number by another. Modulo operation finds remainder: a mod b = remainder of a ÷ b. Shows quotient and remainder. Used in modular arithmetic and programming.',
    related: ['prime-checker', 'factor-calculator', 'percentage-calculator'],
  },
  // Numerical Methods
  {
    slug: 'bisection-method', name: 'Bisection Method Calculator',
    category: 'math', subcategory: 'numerical-methods', inputStyle: 'fields',
    description: 'Find function roots using bisection method.',
    about: 'Bisection method repeatedly narrows interval containing a root. Slower than Newton-Raphson but always converges for continuous functions. Shows iterations, intermediate values, and convergence tolerance.',
    related: ['newton-raphson', 'polynomial-roots', 'derivative-calculator'],
  },
  {
    slug: 'newton-raphson', name: 'Newton-Raphson Calculator',
    category: 'math', subcategory: 'numerical-methods', inputStyle: 'fields',
    description: 'Find function roots using Newton-Raphson method.',
    about: 'Newton-Raphson uses derivatives to find roots rapidly. Formula: x_{n+1} = x_n - f(x_n)/f\'(x_n). Fast convergence but requires derivative and good initial guess. Shows iteration steps.',
    related: ['bisection-method', 'polynomial-roots', 'derivative-calculator'],
  },
  {
    slug: 'trapezoidal-rule', name: 'Trapezoidal Rule Calculator',
    category: 'math', subcategory: 'numerical-methods', inputStyle: 'fields',
    description: 'Approximate integrals using the trapezoidal rule.',
    about: 'Trapezoidal rule approximates integrals by dividing area into trapezoids. More accurate than midpoint rule, less than Simpson\'s rule. Shows subdivisions and convergence improvement.',
    related: ['riemann-sum', 'simpsons-rule', 'integral-calculator'],
  },
  {
    slug: 'simpsons-rule', name: "Simpson's Rule Calculator",
    category: 'math', subcategory: 'numerical-methods', inputStyle: 'fields',
    description: 'Approximate integrals using Simpson\'s rule.',
    about: 'Simpson\'s rule approximates integrals using parabolic arcs. More accurate than trapezoidal rule. Requires even number of intervals. Shows improvement with increasing subdivisions.',
    related: ['trapezoidal-rule', 'riemann-sum', 'integral-calculator'],
  },
  // Algebra (continued - adding missing entries)
  {
    slug: 'absolute-value', name: 'Absolute Value Calculator',
    category: 'math', subcategory: 'algebra', inputStyle: 'fields',
    description: 'Solve absolute value equations and inequalities.',
    about: 'Absolute value |x| represents distance from zero. Solve equations like |x| = 5 (which has two solutions: x = 5 or x = -5) and inequalities. Shows graphical representation.',
    related: ['linear-equation', 'quadratic-solver', 'graphing-calculator'],
  },
  {
    slug: 'inequality-solver', name: 'Inequality Solver',
    category: 'math', subcategory: 'algebra', inputStyle: 'fields',
    description: 'Solve linear, quadratic and polynomial inequalities.',
    about: 'Solve inequalities like 2x + 3 > 7 and x² - 5x + 6 ≤ 0. Shows solution intervals, critical points, and test regions. Visualizes solutions on number line.',
    related: ['linear-equation', 'quadratic-solver', 'graphing-calculator'],
  },
  {
    slug: 'sequence-calculator', name: 'Sequence Calculator',
    category: 'math', subcategory: 'algebra', inputStyle: 'fields',
    description: 'Find nth term and sum of arithmetic and geometric sequences.',
    about: 'Arithmetic sequences have constant difference, geometric have constant ratio. Find any term, sum of first n terms, or sum to infinity (if convergent geometric). Shows formulas and examples.',
    related: ['arithmetic-series', 'exponential-growth', 'polynomial-roots'],
  },
  {
    slug: 'binomial-theorem', name: 'Binomial Theorem Calculator',
    category: 'math', subcategory: 'algebra', inputStyle: 'fields',
    description: 'Expand binomial expressions using the binomial theorem.',
    about: 'Binomial theorem expands (a + b)^n = Σ C(n,k)a^(n-k)b^k. Shows coefficients using Pascal\'s triangle or binomial coefficients. Calculates specific terms in expansion.',
    related: ['combinations', 'polynomial-roots', 'exponent-calculator'],
  },
  {
    slug: 'exponential-growth', name: 'Exponential Growth & Decay',
    category: 'math', subcategory: 'algebra', inputStyle: 'fields',
    description: 'Model exponential growth or decay: y = a(1±r)^t or y = ae^(kt).',
    about: 'Exponential growth/decay models appear in populations, radioactive decay, investment returns. Solves for any parameter: initial amount, rate, time or future value. Shows both forms.',
    related: ['exponent-calculator', 'logarithm-calculator', 'compound-interest'],
  },
  {
    slug: 'complex-numbers', name: 'Complex Numbers Calculator',
    category: 'math', subcategory: 'algebra', inputStyle: 'fields',
    description: 'Arithmetic with complex numbers in rectangular and polar forms.',
    about: 'Complex numbers z = a + bi. Perform addition, subtraction, multiplication, division. Convert between rectangular (a+bi) and polar (r∠θ) forms. Shows operations on Argand diagram.',
    related: ['polynomial-roots', 'exponent-calculator', 'quadratic-solver'],
  },
