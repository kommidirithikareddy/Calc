export const calculators = [
  ...
  },
  {
    ...
    about: 'Pump power depends on flow rate, total head (pressure) and efficiency. Hydraulic power = Ï Ã— g Ã— Q Ã— H. Shaft power = Hydraulic power / efficiency. This calculator computes hydraulic power, required shaft power and motor power accounting for pump and motor efficiencies essential for pump selection.',
    related: ['flow-rate', 'pressure-drop', 'reynolds-number'],
  },
  {
  ...
  },
  {
    ...
    about: 'Horsepower is a unit of power equal to 745.7 watts. It relates to torque and RPM by: HP = Torque(ft-lb) Ã— RPM / 5252. This calculator converts between HP, kW, torque and RPM - and provides both mechanical horsepower (HP) and metric horsepower (PS) values.',
  ...
  // Algebra
  {
    ...
    about: 'The quadratic formula solves any second-degree polynomial equation of the form axÂ²+bx+c=0. This solver computes the discriminant, identifies whether roots are real or complex, and shows the complete step-by-step working using the quadratic formula perfect for checking homework or understanding the process.',
